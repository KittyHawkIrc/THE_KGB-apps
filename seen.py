  ...
  if self.type == 'userjoin':
    ...
    try:
      if u2 == u:
        ...
        return self.msg(self.channel, '%s was last seen joining %s at %s. Also fuck proper formatting. Who do you think you are, a stripper? You don\'t tell me what to do.' % (u2, users[u2][1], users[u2][0]))
    except:
